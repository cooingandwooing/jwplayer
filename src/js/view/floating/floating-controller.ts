...
import type { BoundsObj } from 'types/generic.type';
...
export default class FloatingController {
    ...
    _playerBounds: BoundsObj;

    constructor(model: Model, playerBounds: BoundsObj, elements: { player: HTMLElement; wrapper: HTMLElement; preview: Preview }) {
    ...
    updatePlayerBounds(pb: BoundsObj): void {
